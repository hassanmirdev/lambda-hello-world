...
resource "aws_apigatewayv2_integration" "hello_world" {
  ...
  integration_uri    = aws_lambda_function.hello_world2.invoke_arn  # Updated to use hello_world2
...
resource "aws_lambda_permission" "api_gw" {
  ...
  function_name = aws_lambda_function.hello_world2.function_name  # Updated to use hello_world2
